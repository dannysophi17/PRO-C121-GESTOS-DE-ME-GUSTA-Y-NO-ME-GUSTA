...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmark in results.multi_hand_landmarks:
            ...
            finger_fold_status = []
            for tip in range(1, len(finger_tips)):
                if lm_list[finger_tips[tip]].x < lm_list[finger_tips[tip] - 3].x:
                    x, y = int(lm_list[finger_tips[tip]].x * w), int(lm_list[finger_tips[tip]].y * h)
